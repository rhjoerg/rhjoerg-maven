...
public class StarterSecDispatcher extends DefaultSecDispatcher
{
	@Inject
	public StarterSecDispatcher(Logger logger, PlexusCipher cipher, Map<String, PasswordDecryptor> decryptors)
	{
